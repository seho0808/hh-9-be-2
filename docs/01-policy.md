...
- **동시 주문 요청이 들어올 경우**, 최초로 재고 및 잔액을 확보한 요청만 유효
- 잔액이 보류 상태일 때는 **재사용 불가**
...
- 선착순 쿠폰은 수량 제한이 있으며, **타임 이벤트** 또는 **마케팅 대상자 한정 쿠폰**으로 분리됨
- 발급 조건 예시:
  - 전체 유저 대상, 총 500장 한정
  - 특정 사용자에게만 노출되는 개인 쿠폰
